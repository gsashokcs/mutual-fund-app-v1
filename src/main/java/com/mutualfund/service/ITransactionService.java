...
/**
 * Service interface for transaction and holdings management. Defines contract for buy/redeem
 * operations and portfolio viewing.
 */
public interface ITransactionService {
     ...
     * @throws com.mutualfund.exception.ResourceNotFoundException if mutual fund is not found
     */
     ...
     * @param request the transaction request containing fund ID and units
     * @return TransactionResponse containing transaction details
     * @throws com.mutualfund.exception.BusinessException if holdings not found or insufficient
     *     units
     * @throws com.mutualfund.exception.ResourceNotFoundException if mutual fund is not found
     */
