...
/**
 * Service interface for mutual fund management operations. Defines contract for fund creation, NAV updates, and fund retrieval. NAV values are managed separately in the Nav table with historical tracking.
 */
public interface IMutualFundService {
    ...
    /**
     * Updates or creates the Net Asset Value (NAV) for a mutual fund for a specific date. If a NAV entry exists for the given date, it updates the value. Otherwise, creates a new entry.
     *
     * @param fundId
