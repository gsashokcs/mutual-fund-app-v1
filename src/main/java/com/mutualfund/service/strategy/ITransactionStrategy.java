...
/**
 * Strategy interface for transaction processing. Implements Strategy pattern to handle different
 * transaction types polymorphically.
 */
public interface ITransactionStrategy {
     ...
     * @param units the number of units in the transaction
     * @param nav the net asset value at transaction time
     * @throws com.mutualfund.exception.BusinessException if transaction cannot be processed
     */
     ...
     *
     * @param holding the holding to validate against
     * @param units the number of units in the transaction
